...
class ForecastRecyclerAdapter(val context: Context, val forecastList: List<Forecast>?) : RecyclerView.Adapter<ForecastRecyclerAdapter.ViewHolder>() {
    ...
    * */
    ...
    inner class ViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        private val dayTextView = itemView?.findViewById(R.id.day_text_view) as TextView
        private val weatherImageView = itemView?.findViewById(R.id.weather_image_view) as ImageView
        private val temperatureTextView = itemView?.findViewById(R.id.temperature_text_view) as TextView
