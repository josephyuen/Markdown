...
import app.com.thetechnocafe.kotlinweather.R.id.weather_condition_text_view
...
class HomeActivity : AppCompatActivity(), HomeContract.View {
    ...
    * */
    private fun updateUI(weatherData: WeatherData?) {
        ...
        val weatherConditionTextView = findViewById(weather_condition_text_view) as TextView
    ...
    * */
    ...
    private fun requestLocationUpdates() {
        ...
        mLocationManager?.requestLocationUpdates(provider, 3000, 0.0f, mLocationListener)
